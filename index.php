...
<?php if ( is_home() && is_front_page() ) : ?>
  ...
  <section class="activities_container expanded row" id="activites">
    <h1>Activites</h1>
    <hr>
    <?php
      $args = array(
      ...
      foreach ( $pages as $page ) {
        ...
        echo '<span></span>';
        echo '<hr>';
        echo '<h4><a href="' . $page_link . '">' . $page_tittle .'</a></h4>';
        echo '</header>';
